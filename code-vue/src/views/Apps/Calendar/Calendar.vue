        ...
        <model-body>
          <div class="row">
            <div class="col-md-12 mb-3">
              <label for="eventTitle" class="form-label font-weight-bold text-muted text-uppercase">Description</label>
              <input type="text" class="form-control" id="eventTitle" placeholder="Describe the event" v-model="description">
            ...
            <div class="form-group">
              <label class="form-label" for="eventDateTime">Day and hour</label>
              <input type="datetime-local" class="form-control" placeholder="Enter date" id="date_event" v-model="date_event">
              <p v-if="errors.date_event" class="error">{{ errors.date_event }}</p>
            </div>
            <div class="col-md-12 mb-3">
              <label for="eventPlace" class="form-label font-weight-bold text-muted text-uppercase">Place</label>
              <input type="text" class="form-control" id="eventPlace" placeholder="Enter place" v-model="lieu_event">
              <p v-if="errors.lieu_event" class="error">{{ errors.lieu_event }}</p>
            </div>
            <div class="col-md-12 mb-3">
              <label for="maxParticipants" class="form-label font-weight-bold text-muted text-uppercase">Maximum number</label>
              <input type="text" class="form-control" id="maxParticipants" placeholder="Enter maximum number" v-model="nbr_max">
...
export default {
  ...
  try {
    ...
    // Rediriger vers la page de détails de l'événement avec l'ID récupéré
